...
var getPriceByTokenAddress = function(web3, tokenAddress) {
    ...
    var contract = new web3.eth.Contract(IPancakeFactory["abi"], BlockChainUtilsConstants.PANCAKE_SWAP_FACTORY_ADDRESS)
    return contract.methods.getPair(tokenAddress, BUSD_CONTRACT).call().then((pairAddress) => {
        return LiquidityPairFetcher.getPairInformationWithPairAddress(web3, pairAddress).then((reserves) => {
